...
public class CatUnitTest {
	...
	CatSubmissionSubmission c; // cat object

	@Before
	public void setUp() throws Exception {
    c = CatSubmissionSubmission.createInstance(InstanceType.MOCK, 1, "Jennyanydots");
    ...
    public void testReturnCat() {
        ...
        c.returnCat();
        verify(c).returnCat();
        when(c.getRented()).thenReturn(false); // 模拟returnCat后的状态
        assertFalse(c.getRented());
}
