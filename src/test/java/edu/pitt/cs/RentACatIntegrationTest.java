...
public class RentACatIntegrationTest {
	...
	CatSubmissionSubmission c1; // First cat object
	CatSubmissionSubmission c2; // Second cat object
	CatSubmissionSubmission c3; // Third cat object
	...
	public void setUp() throws Exception {
		...
		c1 = CatSubmissionSubmission.createInstance(InstanceType.IMPL, 1, "Jennyanydots");
		...
		c2 = CatSubmissionSubmission.createInstance(InstanceType.IMPL, 2, "Old Deuteronomy");

		// 4. Create a Cat with ID 3 and name "Mistoffelees", assign to c3 using a call to Cat.createInstance(InstanceType, int, String).
		c3 = CatSubmissionSubmission.createInstance(InstanceType.IMPL, 3, "Mistoffelees");
	...
	public void testGetCatNullNumCats0() {
        ...
        CatSubmissionSubmission result = (CatSubmissionSubmission) method.invoke(r, 2);
	...
	public void testListCatsNumCats3() {
		...
		String expected = "ID1. Jennyanydots" + newline +
						 "ID2. Old Deuteronomy" + newline +
						 "ID3. Mistoffelees" + newline+ newline;
	...
	public void testRenameFailureNumCats0() {
        ...
        assertEquals("Invalid cat ID." + newline+
				"Invalid cat ID." + newline, out.toString());
	}
